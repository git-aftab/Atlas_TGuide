    ...
    <div className="mx-4 md:mx-10 lg:mx-40 h-[30rem]">
      <div className="grid grid-cols-2 items-center justify-center">
        <div className="col-span-2 mb-2 order-2 md:col-span-1 lg:col-span-1 md:order-1">
          ...
          <a href="about">
            <button className="text-white bg-emerald-500 border-none py-2 px-1 rounded-md flex items-center font-bold hover:bg-emerald-200 hover:text-emerald-500 ease-in-out cursor-pointer mt-4">
              Start Exploring{" "}
              <BiSolidRightArrow className="mt-1 text-emerald-800" />{" "}
            </button>
          </a>
        </div>
        <div className="col-span-2 md:col-span-1 lg:col-span-1 order-1  ">
          <video autoPlay loop muted disablePictureInPicture playsInline controls={false}>
